...
> = {
  en: {
    ...
    dispute_created:       { title: "Chargeback opened",        desc: "A buyer disputed a charge — needs admin review." },
    ...
    speaker_question:      { title: "Speaker question",         desc: "A buyer submitted a question for one of the event's speakers." },
  ...
  de: {
    ...
    dispute_created:       { title: "Chargeback eröffnet",      desc: "Ein Käufer hat eine Zahlung angefochten — Admin-Prüfung nötig." },
    ...
    contact_form_received: { title: "Neue Kontaktnachricht",    desc: "Jemand hat das Kontaktformular der Website abgeschickt." },
    newsletter_subscriber: { title: "Newsletter-Abonnent",      desc: "Ein Besucher hat das Newsletter-Abo bestätigt." },
    speaker_question:      { title: "Frage an Speaker:in",      desc: "Ein Käufer hat eine Frage für eine:n Speaker:in der Veranstaltung eingereicht." },
    check_in_milestone:    { title: "Check-in-Meilenstein",     desc: "Event hat 25% / 50% / 75% / 100% Check-in überschritten." },
    waitlist_available:    { title: "Warteliste verfügbar",     desc: "Ein Wartelisten-Käufer kann jetzt buchen." },
    ...
    transfer:              { title: "Ticket übertragen",        desc: "Ein Ticket wurde an einen neuen Inhaber übertragen." },
  ...
  fr: {
    ...
    dispute_created:       { title: "Litige ouvert",            desc: "Un acheteur a contesté un paiement — révision admin requise." },
    ...
    contact_form_received: { title: "Nouveau message contact",  desc: "Un visiteur a envoyé le formulaire de contact." },
    newsletter_subscriber: { title: "Abonné newsletter",        desc: "Un visiteur a confirmé son abonnement." },
    speaker_question:      { title: "Question pour un intervenant", desc: "Un acheteur a soumis une question pour un intervenant de l'événement." },
    check_in_milestone:    { title: "Jalon de check-in",        desc: "L'événement a passé 25% / 50% / 75% / 100% de check-in." },
    waitlist_available:    { title: "Place liste d'attente",    desc: "Un acheteur en liste d'attente peut maintenant acheter." },
    ...
    transfer:              { title: "Billet transféré",         desc: "Un billet a été transféré à un nouveau détenteur." },

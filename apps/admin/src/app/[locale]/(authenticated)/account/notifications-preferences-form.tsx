...
> = {
  ...
  de: {
    ...
    dispute_created:       { title: "Chargeback eröffnet",      desc: "Ein:e Käufer:in hat eine Zahlung angefochten — Admin-Prüfung nötig." },
  ...
  fr: {
    ...
    dispute_created:       { title: "Litige ouvert",            desc: "Un·e acheteur·euse a contesté un paiement — révision admin requise." },

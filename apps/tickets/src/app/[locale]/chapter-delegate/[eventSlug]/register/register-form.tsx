...
const T = {
  en: {
    ...
    lastName: "Last name",
    email: "Email",
    position: "Position / role in your branch",
    positionPh: "Community lead, treasurer, …",
    chapter: "Branch (country)",
    pickChapter: "— Select your branch —",
    leadHeader: "Branch Ambassador (optional, recommended)",
    leadHint:
      "The DBC Ambassador responsible for the region you represent. If you give us their name and email, we'll CC them on your confirmation so they know you're coming.",
    leadName: "Ambassador name",
    leadEmail: "Ambassador email",
  ...
  de: {
    ...
    lastName: "Nachname",
    email: "E-Mail",
    position: "Position / Rolle in deiner Niederlassung",
    positionPh: "Community Lead, Treasurer, …",
    chapter: "Niederlassung (Land)",
    pickChapter: "— Wähle deine Niederlassung —",
    leadHeader: "Niederlassungs-Botschafter:in (optional, empfohlen)",
    leadHint:
      "Der/die zuständige DBC-Botschafter:in deiner Region. Gibst du uns Name und E-Mail, setzen wir sie auf CC, damit sie weiß, dass du kommst.",
    leadName: "Name der/des Botschafter:in",
    leadEmail: "E-Mail der/des Botschafter:in",
  ...
  fr: {
    ...
    lastName: "Nom",
    email: "E-mail",
    position: "Poste / rôle dans votre succursale",
    positionPh: "Lead communauté, trésorier·ère, …",
    chapter: "Succursale (pays)",
    pickChapter: "— Sélectionnez votre succursale —",
    leadHeader: "Ambassadeur·rice de succursale (optionnel, recommandé)",
    leadHint:
      "L’ambassadeur·rice DBC responsable de votre région. Si vous indiquez son nom et son e-mail, nous le/la mettrons en copie pour qu’il/elle soit prévenu·e de votre venue.",
    leadName: "Nom de l’ambassadeur·rice",
    leadEmail: "E-mail de l’ambassadeur·rice",

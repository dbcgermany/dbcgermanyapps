...
const T = {
  en: {
    ...
    leadHeader: "Chapter Ambassador (optional, recommended)",
    leadHint:
  ...
  de: {
    ...
    leadHeader: "Sektions-Botschafter:in (optional, empfohlen)",
    leadHint:
  ...
  fr: {
    ...
    leadHeader: "Ambassadeur·rice d’antenne (optionnel, recommandé)",
    leadHint:

...
const TRANSLATIONS = {
  en: {
    ...
    footer: "Sent by DBC Germany GmbH \u00B7 ticket.dbc-germany.com",
  ...
  de: {
    ...
    footer: "Gesendet von DBC Germany GmbH \u00B7 ticket.dbc-germany.com",
  ...
  fr: {
    ...
    footer: "Envoy\u00E9 par DBC Germany GmbH \u00B7 ticket.dbc-germany.com",

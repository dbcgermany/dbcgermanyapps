...
const T = {
  en: {
    rejected: {
      ...
      greeting: "Hi {name},",
      body: "Unfortunately we couldn't confirm your chapter-delegate registration for {event} at this time.",
      noteLabel: "Note from the team",
      ctaText:
        "If this wasn't expected, please reach out to your Chapter Ambassador or simply reply to this email.",
      closing: "Thanks,",
  ...
  de: {
    rejected: {
      ...
      greeting: "Hallo {name},",
      body: "Leider konnten wir Ihre Anmeldung als Sektions-Delegierte:r für {event} aktuell nicht bestätigen.",
      noteLabel: "Hinweis vom Team",
      ctaText:
        "Falls das nicht erwartet war, sprechen Sie bitte mit Ihrer:Ihrem Sektions-Botschafter:in oder antworten Sie direkt auf diese E-Mail.",
      closing: "Viele Grüße,",
  ...
  fr: {
    rejected: {
      ...
      body: "Nous n'avons pas pu confirmer votre inscription en tant que délégué·e d'antenne pour {event} pour le moment.",
      noteLabel: "Note de l'équipe",
      ctaText:
        "Si cela n'était pas prévu, contactez votre ambassadeur·rice d'antenne ou répondez simplement à cet e-mail.",
